                                    ...
                                    Column(
                                      ...
                                      children: [
                                            ...
                                            children: [
                                              ClipRRect(
                                                ...
                                                child: Image.network(
                                                  widget.pohon!.fotoPohon.isNotEmpty
                                                      ...
                                                      : 'https://via.placeholder.com/150?text=Foto+Pohon+1',
                                              ...
                                              ClipRRect(
                                                ...
                                                child: Image.network(
                                                  widget.pohon!.fotoPohon.isNotEmpty
                                                      ? widget.pohon!.fotoPohon
                                                      : 'https://via.placeholder.com/150?text=Foto+Pohon+2',
                                                  width: screenWidth * 0.35,
                                                  height: screenHeight * 0.25,
                                                  fit: BoxFit.cover,
                                                  errorBuilder: (context, error, stackTrace) => Container(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                child: Text(
                                                  'Prioritas: ${widget.pohon!.prioritas == 1 ? "Rendah" : widget.pohon!.prioritas == 2 ? "Sedang" : widget.pohon!.prioritas == 3 ? "Tinggi" : "Tinggi"}',
                                                  style: TextStyle(
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.fromLTRB(16, 8, 16, 8),
                                          child: Text(
                                            'Deskripsi: ${widget.pohon!.tujuanPenjadwalan == 1 ? "Penebangan" : widget.pohon!.tujuanPenjadwalan == 2 ? "Pemangkasan" : "Pohon ini berada di lokasi strategis untuk penanaman ulang."}',
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.fromLTRB(16, 8, 16, 8),
                                          child: Text(
                                            'Catatan Tambahan: ${widget.pohon!.catatan.isNotEmpty ? widget.pohon!.catatan : "Perlu perhatian khusus untuk pemeliharaan."}',
                                            style: TextStyle(fontSize: screenWidth * 0.04),
                                          ),
                                        ),
                                        Padding(
