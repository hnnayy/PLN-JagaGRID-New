...
import 'daftar_wilayah.dart'; // Import halaman DaftarWilayahPage

class DaftarJTMPage extends StatefulWidget {
  @override
  _DaftarJTMPageState createState() => _DaftarJTMPageState();
}

class _DaftarJTMPageState extends State<DaftarJTMPage> {
  ...
  void _onItemTap(String ulpName) {
    if (ulpName == 'DATABASE') {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => DaftarWilayahPage(),
        ),
      );
    }
