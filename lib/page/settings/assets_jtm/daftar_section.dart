...
class DaftarSectionPage extends StatefulWidget {
  @override
  _DaftarSectionPageState createState() => _DaftarSectionPageState();
}

class _DaftarSectionPageState extends State<DaftarSectionPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          'Daftar Section', // Ubah title menjadi "Daftar Section"
          style: TextStyle(
            color: Colors.white,
            fontSize: 18,
